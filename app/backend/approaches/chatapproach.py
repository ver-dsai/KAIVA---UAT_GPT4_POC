...
class ChatApproach(Approach, ABC):
    ...
    def get_system_prompt(self, override_prompt: Optional[str], follow_up_questions_prompt: str) -> str:
        ...
        # def get_system_prompt(self, override_prompt: Optional[str], follow_up_questions_prompt: Optional[str]) -> str:
        #     if override_prompt is None:
        #         return self.system_message_chat_conversation.format(
        #             injected_prompt="", follow_up_questions_prompt=follow_up_questions_prompt or "true"
        #         )
        #     elif override_prompt.startswith(">>>"):
        #         return self.system_message_chat_conversation.format(
        #         injected_prompt=override_prompt[3:] + "\n", follow_up_questions_prompt=follow_up_questions_prompt or "true"
        #         )
        #     else:
        #         return override_prompt.format(follow_up_questions_prompt=follow_up_questions_prompt or "true")
